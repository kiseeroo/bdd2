package bd2;
public class OldTime extends OldStudyDuration {

    public int elementaryClassWeek;
    public int middleClass;
    public int highClass;
    public int higherEd;
    public int elementaryClassTime = 24;
    public int middleClassTime = 34;
    public int highClassTime = 36;
    public int higherEdTime = 18;
